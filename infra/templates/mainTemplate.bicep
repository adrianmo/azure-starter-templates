...
resource publicIPAddressName_IP 'Microsoft.Network/publicIPAddresses@2019-11-01' = {
...
resource vmNamePrefix_nic 'Microsoft.Network/networkInterfaces@2019-11-01' = {
  ...
  dependsOn: [ publicIPAddressName_IP ]
}

resource vmNamePrefix_app 'Microsoft.Compute/virtualMachines@2019-12-01' = {
